...
<script type="text/javascript">
	...
	var cropWidth=0;
	var cropHeight=0;
	var sourcePicShowUrl = "http://dp.etest.net.cn/source/JLPT/5/70/MqpCXFbxHYZCXqMyPOJekPbkXjVZWlDY.jpg?t="+ new Date().getTime();
	var maxWidth = 100;
	var maxHeight = 100;
	var finalWidth = 150;
	var finalHeight = 200;
  ...
  <div class="maincontent">
	...
	style="padding-top: 5px; font-size: 12px; margin: 2px; border: 1px solid #CCC">
        <table width="100%" border="0" cellpadding="6" cellspacing="1">
          <tr>
            <td width="60%" valign="top" nowrap="nowrap" align="center"><div id="bgDiv" style="width:100px; height:100px;">
                <div id="dragDiv">
          ...
          <tr>
            <td align="center" colspan="2"><form action="cropImage.do" method="post">
